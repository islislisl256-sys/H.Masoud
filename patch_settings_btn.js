...
const replacement = \</button>
            ...
            <div className="pt-4 mt-6 border-t border-gray-100 dark:border-gray-700">
              <button onClick={() => window.location.href = '/chat'} className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-4 py-4 rounded-xl hover:opacity-90 transition-opacity font-bold shadow-sm">
