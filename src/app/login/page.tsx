...
import { BookOpen, AlertOctagon, Phone, Briefcase, ArrowRight, Monitor, Smartphone, Apple, X, Share } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4 sm:px-6 lg:px-8 relative">
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl">
        <div className="flex flex-col items-center">
          <div className="h-20 w-20 bg-gray-50 dark:bg-gray-700/50 rounded-full flex items-center justify-center mb-4 p-2 shadow-sm border border-gray-100 dark:border-gray-600">
